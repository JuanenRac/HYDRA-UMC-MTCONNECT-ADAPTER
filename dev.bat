@echo off
REM =============================================================================
REM HYDRA-UMC MTCONNECT ADAPTER - Development Server Start Script
...
echo ========================================
echo  Starting HYDRA-UMC MTCONNECT ADAPTER (Dev Mode)
echo ========================================
call npm run dev
if errorlevel 1 (
  echo.
  echo HYDRA-UMC MTCONNECT ADAPTER exited with an error.
  pause
  exit /b 1
)
pause
